...
class SpotifyAuthenticator:
    ...
    def __init__(self):
        ...
        self.cache = CacheFileHandler(keys_to_lights.idontknow.CACHE_PATH)

        self.auth = SpotifyOAuth(
            scope=["user-read-currently-playing"],
            client_id=keys_to_lights.idontknow.SPOTIFY_CLIENT_ID,
            client_secret=keys_to_lights.idontknow.SPOTIFY_CLIENT_SECRET,
